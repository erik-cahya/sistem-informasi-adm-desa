            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="/pengumuman/create/" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body row">

                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="input-nama_lengkap">Judul Pengumuman</label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="creator" name="creator" type="text" class="form-control"
                                            value="{{ Auth::user()->username }}" placeholder="Isi Penulis Pengumuman"
                                            readonly>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="pengumuman" name="pengumuman" class="form-control" required></textarea>
