              ...
              <div class="col-lg-12">
                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          <a href="{{ route('keluarga.add') }}" type="button" class="btn btn-success mb-4"> <i
                                  class="bx bx-plus"></i>&nbsp;Buat
                              Baru</a>
              ...
              <div class="modal-content">
                  ...
                  <form id="form_edit_keluarga" method="post">
                      <div class="modal-body">
                          ...
                          <button type="submit" class="btn btn-info mb-4 float-right">Perbarui Data</button>
