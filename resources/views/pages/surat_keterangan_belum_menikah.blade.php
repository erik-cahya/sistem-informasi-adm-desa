                      ...
                      <div class="card-body">
                          ...
                          <form id="form_create_surat">
                              ...
                              <div class="modal-body">
                                  ...
                                  <div class="row mb-3">
                                      <label for="input-keperluan" class="col-sm-2 col-form-label">Keperluan</label>
                                      <div class="col-sm-10">
                                          <input id="input-keperluan" type="text" class="form-control form-control-sm"
                                              value="" name="keperluan">
                                          <div class="invalid-feedback">
                                              <span id="message-keperluan"></span>
                                          </div>
                                      </div>
                                  </div>
      ...
      <script>
          $(document).ready(function() {
              ...
              $("#form_create_surat").submit(function(event) {
                  ...
                  data_input.keperluan = $("#input-keperluan").val();
                  ...
                  $.ajax({
                      url: "{{ route('surat.surat_keterangan_belum_menikah.create') }}",
                      method: 'POST',
                      dataType: 'json',
