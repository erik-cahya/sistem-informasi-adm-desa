                      ...
                      <div class="card-body">
                          ...
                          <form id="form_create_surat">
                              ...
                              <div class="modal-body">
                                  ...
                                  <div class="row mb-3">
                                      <label for="input-nama_usaha" class="col-sm-2 col-form-label">Nama Usaha</label>
                                      <div class="col-sm-10">
                                          <input id="input-nama_usaha" type="text"
                                              class="form-control form-control-sm" value="" name="nama_usaha">
                                          <div class="invalid-feedback">
                                              <span id="message-nama_usaha"></span>
                                          </div>
                                      </div>
                                  </div>

                                  <div class="row mb-3">
                                      <label for="input-alamat_usaha" class="col-sm-2 col-form-label">Alamat Usaha</label>
                                      <div class="col-sm-10">
                                          <input id="input-alamat_usaha" type="text"
                                              class="form-control form-control-sm" value="" name="alamat_usaha">
                                          <div class="invalid-feedback">
                                              <span id="message-alamat_usaha"></span>
                                          </div>
                                      </div>
                                  </div>
      ...
      <script>
          $(document).ready(function() {
              ...
              $("#form_create_surat").submit(function(event) {
                  ...
                  data_input.nama_usaha = $("#input-nama_usaha").val();
                  data_input.alamat_usaha = $("#input-alamat_usaha").val();
                  ...
                  $.ajax({
                      url: "{{ route('surat.surat_keterangan_usaha.create') }}",
                      method: 'POST',
                      dataType: 'json',
