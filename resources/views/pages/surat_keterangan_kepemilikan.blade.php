                      ...
                      <div class="card-body">
                          ...
                          <form id="form_create_surat">
                              ...
                              <div class="modal-body">
                                  ...
                                  <div class="row mb-3">
                                      <label for="input-status_nikah" class="col-sm-2 col-form-label">Status</label>
                                      <div class="col-sm-10">
                                          ...
                                          <div class="invalid-feedback">
                                              <span id="message-status_nikah"></span>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="row mb-3">
                                      <label for="input-pekerjaan" class="col-sm-2 col-form-label">Pekerjaan</label>
                                      <div class="col-sm-10">
                                          <input id="input-pekerjaan" type="text" class="form-control form-control-sm"
                                              value="" name="pekerjaan">
                                          <div class="invalid-feedback">
                                  ...
                                  <div class="row mb-3">
                                      <label for="input-pemilik_dari" class="col-sm-2 col-form-label">Pemilik dari</label>
                                      <div class="col-sm-10">
                                          <input id="input-pemilik_dari" type="text"
                                              class="form-control form-control-sm" value="" name="pemilik_dari">
                                          <div class="invalid-feedback">
                                              <span id="message-pemilik_dari"></span>
                                          </div>
                                      </div>
                                  </div>
      ...
      <script>
          $(document).ready(function() {
              ...
              $("#form_create_surat").submit(function(event) {
                  ...
                  data_input.pemilik_dari = $("#input-pemilik_dari").val();
