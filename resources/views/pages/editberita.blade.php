                                ...
                                <div class="modal-body row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input id="judul" name="judul" type="text" class="form-control" value="{{ $berita->judul }}" required>

                                            <input id="id" name="id" type="hidden" class="form-control" value="{{ $berita->id }}" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input id="creator" name="creator" type="text" class="form-control" value="{{ $berita->creator }}" required placeholder="Isi Penulis Berita"
                                            readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="kategori" name="kategori" class="form-control custom-select" required>
                                                ...
                                                @foreach ($kategori as $kat)
                                                    <option value="{{ $kat->id }}" {{ ( $kat->id == $berita->kategori) ? 'selected' : '' }} >
                                                        {{ $kat->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="berita" name="berita" class="form-control" required>{{ $berita->berita }}</textarea>
