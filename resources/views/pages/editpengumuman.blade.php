              ...
              <div class="col-lg-12">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form method="post" action="/pengumuman/update/"
                                ...
                                <div class="modal-body row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input id="judul" name="judul" type="text" class="form-control" value="{{ $pengumuman->judul }}" required>

                                            <input id="id" name="id" type="hidden" class="form-control" value="{{ $pengumuman->id }}" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input id="creator" name="creator" type="text" class="form-control" value="{{ $pengumuman->creator }}" required placeholder="Isi Penulis Pengumuman"
                                            readonly>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="input-nama_lengkap">Isi Pengumuman</label>
                                            <textarea id="pengumuman" name="pengumuman" class="form-control" required>{{ $pengumuman->pengumuman }}</textarea>
