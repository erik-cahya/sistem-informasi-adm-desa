...
@section('content')
                ...
                <div class="card info-card sales-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item" onclick="getBy('penduduk','total')">Total</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Penduduk <span id="byDate-penduduk">| Total</span></h5>
                ...
                <div class="card info-card revenue-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item" onclick="getBy('keluarga','total')">Total</a>
                            </li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Keluarga <span id="byDate-keluarga">| Total</span></h5>
                ...
                <div class="card info-card customers-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item" onclick="getBy('surat','total')">Total</a>
                            </li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Surat <span id="byDate-surat">| Total</span></h5>
                ...
                <div class="card info-card mutasi-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item" onclick="getBy('mutasi','total')">Total</a>
                            </li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Mutasi <span id="byDate-mutasi">| Total</span></h5>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Column Chart -->
                        <div id="loading-pieMutasi"></div>
                        <div id="columnChart"></div>

                        <script>
                            document.addEventListener("DOMContentLoaded", () => {
                                loading('show', 'pieMutasi');
                                $.ajax({
    ...
    <script>
        $(document).ready(function() {
            ...
            //   -------------------
            getBy('penduduk', 'total');
            getBy('keluarga', 'total');
            getBy('surat', 'total');
            getBy('mutasi', 'total');
        });
        //set default data
