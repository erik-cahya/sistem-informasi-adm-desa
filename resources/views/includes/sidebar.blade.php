...
@if (auth()->user()->level === 'admin')
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::segment(1) == 'keluarga' ? '' : 'collapsed' }}"
                href="{{ route('keluargas') }}">
                <i class="ri-folder-5-fill"></i>
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::segment(2) == 'masuk' ? '' : 'collapsed' }}"
                href="{{ route('mutasi.masuk') }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ $title == 'Data surat' ? '' : 'collapsed' }}" href="{{ route('pengajuan-surat') }}">
                <i class="bi bi-file-earmark-text"></i>
        ...
        <li class="nav-item">
            ...
            <ul id="components-nav"
                class="nav-content collapse {{ Request::segment(1) == 'buat-surat' ? 'show' : ' ' }}"
                ...
                <li>
                    <a href="{{ route('surat.surat_keterangan_kepemilikan') }}"
                        class="{{ Request::segment(2) == 'keterangan-kepemilikan' ? 'active' : '' }}">
        ...
        <li class="nav-heading">Manajemen Berita</li>

        <li class="nav-item">
            <a class="nav-link {{ $title == 'Data surat' ? '' : 'collapsed' }}" href="{{ route('berita') }}">
                <i class="bi bi-file-earmark-text"></i>
        ...
        <li class="nav-item">
            <a class="nav-link {{ $title == 'Data surat' ? '' : 'collapsed' }}" href="{{ route('kategori') }}">
                <i class="bi bi-file-earmark-text"></i>
                <span>Kategori Berita</span>
            </a>
        </li>

        <li class="nav-heading">Manajemen Pengumuman</li>

        <li class="nav-item">
            <a class="nav-link {{ $title == 'Data surat' ? '' : 'collapsed' }}" href="{{ route('pengumuman') }}">
                <i class="bi bi-file-earmark-text"></i>
...
@if (auth()->user()->level === 'warga')
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->segment(1) == 'surat-saya' ? '' : 'collapsed' }}"
                href="{{ route('surat-saya') }}">
                <i class="bi bi-file-earmark-text"></i>
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->segment(1) == 'list-pengajuan' ? '' : 'collapsed' }}"
                href="{{ route('list-pengajuan') }}">
                <i class="bi bi-file-earmark-text"></i>
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->segment(1) == 'pengajuan-surat' ? '' : 'collapsed' }}"
