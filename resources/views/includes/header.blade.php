<div class="d-flex align-items-center justify-content-between">
    <div class="logo d-flex align-items-center">
        <img src="{{ asset('res/assets/my-image/Kabupaten_Batanghari.png') }}" alt="lanbang kabupaten banggai laut">
        <span class="d-none d-lg-block">Sistem Informasi <br>Desa Rantau Puri</span>
    </div>
    ...
    <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
            ...
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                <img src="{{ asset('res/assets/img/profile.jpg') }}" alt="Profile" class="rounded-circle">
