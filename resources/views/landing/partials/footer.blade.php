<footer class="text-white"
    ...
    <div class="container py-4 py-lg-5">
            ...
            <div
                ...
                <div class="fw-bold d-flex align-items-center mb-2">
                    <a class="navbar-brand d-flex align-items-center" data-bss-hover-animate="pulse" href="/">
                        <img src="{{ asset('storage/images/logodpn_batanghari.png') }}" alt="Logo" width="230" height="48"
                            class=""></a>
                </div>
                <p class="text-white">Website Resmi Rantau Puri, Kecamatan Muara Bulian
                    berfungsi sebagai pusat informasi pemerintah bagi masyarakat selaku
                    penerima manfaat.</p>
            </div>
                ...
                <ul class="list-unstyled">
                    <li data-bss-hover-animate="pulse">
                        <a class="navbar-brand" href="#">
                            ...
                            </svg>Website Kecamatan Muara Bulian</a>
                    </li>
                </ul>
            </div>
            <div class="col-sm-4-text-center col-md-3 text-lg-start d-flex flex-column">
                ...
                <ul class="list-unstyled">
                    <li>Pemerintahan Desa Rantau Puri</li>
                    <li>E-Mail: desarantaupuri@gmail.com</li>
                    <li>Nomor Telp: 082397705152</li>
                </ul>
            </div>
        ...
        <div class="d-flex justify-content-between align-items-center pt-3">
            <p class="mb-0">Copyright © 2023 Pemerintahan Desa Rantau Puri</p>
        </div>
    </div>
</footer>
