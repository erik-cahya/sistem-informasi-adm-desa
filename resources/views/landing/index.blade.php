        ...
        <div class="container h-100">
            <div class="row h-100">
                <div
                    ...
                    <div>
                        <h5 class="fw-semibold mb-3 responsive-mini" style="color: rgb(255,255,255);">Desa Rantau Puri
                        ...
                        <p class="fw-semibold mb-4 responsive-p" style="color: rgb(255,255,255);">Rantau Puri adalah desa yang berada di Kecamatan Muara Bulian, Kab. Batanghari, Jambi - Indonesia
                        </p>
        ...
        <div class="m-md-5 m-sm-4 px-md-2 px-sm-0">
                ...
                <div class="col-md-8 col-sm-12">
                    ...
                    @foreach ($newses as $news)
                        <div class="card mb-3" data-bss-hover-animate="pulse">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="{{ asset('storage/images/' . $news->thumbnail) }}" class="img-fluid rounded-start">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-6">
                            <div class="card text-white bg-success bg-gradient h-100" data-bss-hover-animate="pulse">
                                <div class="card-body">
                                    ...
                                    <h1 class="fw-bold mb-0">{{ $total }} KK</h1>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 text-center">
                    ...
                    <hr style="border: 1px solid green; border-radius: 5px;">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d43229.25511376878!2d103.2837326098229!3d-1.65252978914615!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e2f704befce9641%3A0x935316baf167f5e7!2sRantau%20Puri%2C%20Kec.%20Muara%20Bulian%2C%20Kabupaten%20Batang%20Hari%2C%20Jambi!5e1!3m2!1sid!2sid!4v1694959307294!5m2!1sid!2sid"
