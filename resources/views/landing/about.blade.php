...
@section('container')
    ...
    <div class="py-1 py-xl-1 px-md-5 px-sm-0 mx-5">
        <div class="m-md-5 m-sm-4 px-md-2 px-sm-0">
            ...
            <h2 style="color:#064708;"><b>Tentang Sistem Informasi Desa Rantau Puri</b></h2>
            <hr style="border: 1px solid green;
            border-radius: 5px;">
            <p><b>Mewujudkan Digitalisasi Media Informasi Desa melalui Sistem Informasi Desa Rantau Puri</b></p>
            <p>Sistem Informasi Desa Rantau Puri adalah wadah pengelolaan dan penyebaran informasi secara digital melalui
                ...
                kolaborasi antara Pemerintahan Desa Rantau Puri dan Universitas Bengkulu melalui program Kuliah Kerja Nyata
            ...
            <div class="card">
                <div class="card-body">
                    <p><b>Desa Rantau Puri, Kecamatan Pematang Tiga, Kecamatan Muara Bulian, Provinsi Bengkulu</b></p>
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>Alamat</td>
                                <td>Jalan Desa Rantau Puri</td>
                            </tr>
                            <tr>
                                <td>Kode Pos</td>
                                <td>38372</td>
