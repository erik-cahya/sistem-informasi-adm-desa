...
<body id="LoginForm" style="font-family: 'Epilogue', sans-serif;">
    <div class="container">
        <div class="login-form">
            <div class="main-div">
                <div class="panel">
                    <img src="{{ asset('storage/images/logo_batanghari.png') }}"
                        style="max-height: 100px;object-fit: cover;">
                    <h2>Portal Administrator Sistem Informasi Desa Rantau Puri</h2>
            ...
            <p class="botto-text">Pemerintah Desa Rantau Puri</p>
        </div>
    </div>
</body>
